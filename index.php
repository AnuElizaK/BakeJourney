    ...
    <nav class="navbar" id="navbar">
      <div class="container">
        <div class="nav-content">
          <div class="nav-brand">
              <a href="index.php"><img src="media/Logo.png" alt="BakeJourney Logo" width="40" height="40" style="vertical-align: top;"></a>
    ...
    <section class="become-baker-cta">
      <div class="container">
        <div class="cta-card">
          ...
          <p>Join our community of talented homebakers and showcase your delicious creations to food lovers everywhere!</p>
      ...
      <div class="container">
        <div class="about-content">
          <div class="about-text">
            ...
            <p>BakeJourney exists to support home bakers who dream big and bake even bigger. Born from the real challenges faced by small, home-based bakeries, our platform is designed to be your one-stop digital toolkit and simplify day-to-day operations, so bakers can stay focused on the flour-dusted magic in the kitchen.</p>
            <p>Whether it's managing orders, tracking your inventory, or connecting with loyal customers, BakeJourney is here to support your journey with style, efficiency, and a sprinkle of sweetness.</p>
            <p>And for customers craving something special? BakeJourney helps them discover talented local bakers, browse personalized menus, place custom orders, and support small businesses, all from the comfort of home.</p>
          ...
          <div class="about-image">
            <img src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Baker at work">

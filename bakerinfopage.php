...
<body>
    ...
    <main class="container">
        ...
        <section class="profile-section">
            ...
            <div class="contact-details">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-info">
                        <p><?= htmlspecialchars($baker['order_lead_time'] ?: 'Not specified'); ?></p>
                    </span>
                </div>
                <div class="detail-item">
                    ...
                    <span class="detail-info">
                        <p><?= htmlspecialchars($baker['availability'] ?: 'Not specified'); ?></p>
                    </span>
                </div>
                <div class="detail-item">
                    ...
                    <span class="detail-info">
                        <p><?= htmlspecialchars($baker['custom_orders']); ?></p>
                    </span>
                </div>
            </div>
            <div class="profile-actions">
                <?php if (in_array($baker['custom_orders'], ['Takes custom orders', 'Takes limited custom orders']) && $_SESSION['role'] === 'customer' || $_SESSION['role'] === 'baker' && $_SESSION['user_id'] === $baker_id): ?>
                    <a href="bakerinfopage.php?baker_id=<?= $baker_id ?>&chat=open#chatModal" class="btn btn-primary"
                        id="chatBtn">
        ...
        <div id="chatModal" class="chat-modal"
            style="<?= isset($_GET['chat']) && $_GET['chat'] === 'open' ? 'display: flex;' : '' ?>">
            <div class="chat-container">
                <div class="chat-header">
                    ...
                    <button onclick="window.location.href='bakerinfopage.php?baker_id=<?= $baker_id ?>'"
                        class="chat-close" style="text-decoration: none;">&times;</button>
                </div>
